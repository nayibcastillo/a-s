...
class CreateConfiguracionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('Configuracion', function (Blueprint $table) {
            $table->integer('Id_Configuracion', true);
            ...
            $table->integer('Comprobante_Egreso')->nullable()->default(0);
            $table->integer('Comprobante_Ingreso')->nullable()->default(0);
            $table->integer('Cotizacion')->nullable()->default(0);
            $table->integer('Devolucion_Compras')->nullable()->default(0);
            $table->integer('Devolucion_Remision')->nullable()->default(0);
            $table->integer('Devolucion_Ventas')->nullable()->default(0);
            $table->integer('Homologo')->nullable()->default(0);
            ...
            $table->integer('Nota_Credito')->nullable()->default(0);
            $table->integer('Nota_Debito')->nullable()->default(0);
            $table->integer('Orden_Compra')->nullable()->default(0);
            ...
            $table->integer('Remision')->nullable()->default(0);
            $table->integer('Traslado')->nullable()->default(0);
            ...
            $table->string('Prefijo_Nota_Credito', 100)->nullable()->default('NC');
            $table->string('Prefijo_Comprobante_Ingreso', 20)->nullable()->default('COI');
            $table->string('Prefijo_Comprobante_Egreso', 20)->nullable()->default('COE');
            $table->string('Prefijo_Nota_Contable', 45)->nullable()->default('N');
            $table->integer('Nota_Contable')->nullable()->default(1);
            $table->integer('Meses_Vencimiento')->default(3);
            $table->string('Productos_Pendientes_Libres', 45)->nullable()->default('No');
            ...
            $table->string('Prefijo_Gasto_Punto', 45)->nullable()->default('GS');
            ...
            $table->integer('Balanza')->nullable()->default(0);
        });
    }
