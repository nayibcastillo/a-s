...
class CreateProductoRemisionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('Producto_Remision', function (Blueprint $table) {
            $table->bigInteger('Id_Producto_Remision', true);
            ...
            $table->decimal('Precio', 50)->nullable();
            $table->decimal('Costo', 50)->nullable();
            $table->integer('Descuento')->nullable();
            $table->integer('Impuesto')->nullable();
            $table->decimal('Subtotal', 50)->nullable();
            $table->decimal('Total_Descuento', 50)->default(0);
            $table->decimal('Total_Impuesto', 50)->default(0);
            $table->bigInteger('Id_Inventario_Nuevo')->nullable();
            $table->boolean('Costo_Actualizado')->nullable()->comment('actualizacion de costos masivos ');
        });
    }
