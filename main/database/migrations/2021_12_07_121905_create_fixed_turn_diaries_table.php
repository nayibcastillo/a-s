...
class CreateFixedTurnDiariesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('fixed_turn_diaries', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->decimal('temp_one', 11, 1)->nullable()->default(0);
            $table->decimal('temp_two', 11, 1)->nullable()->default(0);
            $table->decimal('temp_three', 11, 1)->nullable()->default(0);
            $table->decimal('temp_four', 11, 1)->nullable()->default(0);
        });
    }
