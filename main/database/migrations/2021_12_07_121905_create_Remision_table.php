...
class CreateRemisionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('Remision', function (Blueprint $table) {
            $table->bigInteger('Id_Remision', true);
            ...
            $table->integer('Id_Lista')->nullable()->default(1);
            ...
            $table->decimal('Costo_Remision', 12)->nullable();
            ...
            $table->decimal('Subtotal_Remision', 12)->default(0);
            $table->decimal('Descuento_Remision', 12)->default(0);
            $table->decimal('Impuesto_Remision', 12)->default(0);
            ...
            $table->enum('Entrega_Pendientes', ['Si', 'No'])->nullable()->default('No');
