...
class CreatePeopleTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('people', function (Blueprint $table) {
            ...
            $table->enum('marital_status', ['Soltero(a)', 'Casado(a)', 'Divorciado(a)', 'Viudo(a)', 'Union Libre', 'Unión Libre(a)'])->nullable();
            ...
            $table->integer('people_type_id')->nullable()->default(2);
            ...
            $table->tinyInteger('can_schedule')->default(0);
